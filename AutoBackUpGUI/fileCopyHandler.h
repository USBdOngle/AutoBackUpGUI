...
public:
	...
	~fileCopyHandler();
	static QString extractName(const QString &filePath); //extracts name of file from its source path in format "/filename", static because we need it in googleDriveInterface
